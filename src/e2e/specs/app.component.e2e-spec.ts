...
t.describe('App', function () {
  ...
  t.it('should contain a language switcher', function () {
    t.e(element(by.css('sd-app sd-actionbar lang-switcher')).isPresent()).toEqual(true);
    t.e(element.all(by.css('sd-app sd-actionbar lang-switcher option')).count()).toEqual(5);
  });
